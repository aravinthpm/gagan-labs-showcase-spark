        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
          <div className="md:col-span-1">
            ...
            >
              ...
              <p className="mb-6">
                Transforming bold ideas into thriving enterprises—driving innovation across India.
              </p>
            ...
            >
              ...
              <ul className="space-y-3">
                {["Acceleration", "Mentorship", "Funding", "Workshops", "Events"].map((item) => (
                  <li key={item}>
                    <a href="#" className="hover:text-gagan-purple transition-colors duration-300">
                      {item}
                    </a>
                  </li>
                ))}
